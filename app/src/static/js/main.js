let provider_butts = document.querySelectorAll(".provider_nav_butt")
...
provider_butts.forEach(provider_butt => {
    provider_butt.addEventListener('click', () => {
        provider_butts.forEach(butt => {
            butt.classList.remove("provider_nav_butt_active");
        });
        ...
        provider_butt.classList.add("provider_nav_butt_active");
